...
var date = new Date();
var md = 0, mx, my;
var lastRenderTime = date.getTime();
var fps = 0;
var frame = [];
...
function draw() {
    ...
    var total = 0;
    while (frame[0].time < lastRenderTime - 1000) {
        frame.shift();
    }
    for (var f of frame) {
        total += f.render;
    }
    document.getElementById("fps").innerHTML = "fps: " + Math.floor(1000 / total * frame.length);
}
